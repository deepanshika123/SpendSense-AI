    ...
    return (
      <div className="min-h-screen bg-stone-950 flex items-center justify-center p-4">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-stone-100 mb-2">Account Created!</h2>
          <p className="text-stone-400 mb-6">Redirecting to login page...</p>
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="bg-stone-900/50 backdrop-blur-sm border border-stone-800/50 rounded-lg p-8 space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full px-4 py-3 bg-linear-to-br from-amber-600 to-amber-700 text-white rounded-lg font-medium hover:shadow-lg hover:shadow-amber-600/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-stone-900/50 text-stone-500">Already have an account?</span>
            </div>
          </div>
